...
pluginName = "ice.render.xlsxConverter"
pluginDesc = "converts Excel 2007 documents to HTML and PDF"
...
class XlsxConverter(odsBaseConverter):
    fromToExts = {".xlsx":[".htm", ".pdf"]}
