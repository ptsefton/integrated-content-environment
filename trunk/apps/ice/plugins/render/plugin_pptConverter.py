...
pluginName = "ice.render.pptConverter"
pluginDesc = "converts Power Point documents to HTML and PDF"
...
class PptConverter(odpBaseConverter):
    fromToExts = {".ppt":[".htm", ".pdf"]}
